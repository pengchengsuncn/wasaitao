...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?act=store_order&op=change_state&state_type=modify_order_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      ...
      <dd>
        ...
        <input type="hidden" class="text" id="shipping_fee" name="shipping_fee" value="<?php echo $output['order_info']['shipping_fee']; ?>"/>
      </dd>
    </dl>
    <dl class="bottom">
      <dt>&nbsp;</dt>
