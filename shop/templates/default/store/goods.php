  ...
  <div class="ncs-detail"><!-- S 商品举报 -->
    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-key"> 
        ...
        <!-- E 购买按钮 -->
        <div class="ncs_share"> <div style="padding:5px; float:left;"><i class="icon-share"></i><?php echo $lang['goods_index_snsshare_goods'];?></div>
        	<div class="bdsharebuttonbox" style="float:left;"><a href="#" class="bds_more" data-cmd="more"></a><a title="分享到QQ空间" href="#" class="bds_qzone" data-cmd="qzone"></a><a title="分享到新浪微博" href="#" class="bds_tsina" data-cmd="tsina"></a><a title="分享到腾讯微博" href="#" class="bds_tqq" data-cmd="tqq"></a><a title="分享到人人网" href="#" class="bds_renren" data-cmd="renren"></a><a title="分享到微信" href="#" class="bds_weixin" data-cmd="weixin"></a></div><div style="padding:3px; float:right;"><a href="javascript:collect_goods('<?php echo $output['goods']['goods_id']; ?>','count','goods_collect');"><i class="icon-star-empty"></i><?php echo $lang['goods_index_favorite_goods'];?><em nctype="goods_collect"><?php echo $output['goods']['goods_collect']?></em></a></div>
