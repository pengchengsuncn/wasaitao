...
<div class="public-top-layout w">
  <div class="topbar wrapper">  
    ...
    <?php }?><span class="seller-login"><a href="<?php echo urlShop('seller_login','show_login');?>" target="_blank" title="登录商家管理中心"><i class="icon-signin"></i>商家管理中心</a></span></div>
    
    <div class="quick-menu">
     <dl>
        <dt><a href="<?php echo SHOP_SITE_URL;?>/index.php">返回首页</a><i></i></dt>
     </dl>
      <dl>
      ...
      <dl>
       ...
       <dd>
          <ul>
            <li><a href="http://www.wasaitao.cn/shop/index.php?act=article&op=show&article_id=63">在线客服</a></li>
            <li><a href="http://www.wasaitao.cn/shop/index.php?act=article&op=article&ac_id=2">帮助中心</a></li>
          </ul>
        </dd>
      </dl>
      <?php 
