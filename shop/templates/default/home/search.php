  ...
  <div class="right">
    ...
    <div class="shop_con_list" id="main-nav-holder">
      ...
      <div class="nch-all-category">
        ...
        <div class="nch-sortbar-owner">商品类型： <span><a href="<?php echo dropParam(array('type'));?>" <?php if (!isset($_GET['type']) || !in_array($_GET['type'], array(1,2))) {?>class="selected"<?php }?>><i></i>全部</a></span> <span><a href="<?php echo replaceParam(array('type' => '1'));?>" <?php if ($_GET['type'] == 1) {?>class="selected"<?php }?><?php /*?><i></i>商城自营</a></span> <span><a href="<?php echo replaceParam(array('type' => '2'));?>"<?php */?> <?php if ($_GET['type'] == 2) {?>class="selected"<?php }?>><i></i>商家加盟</a></span> </div>
