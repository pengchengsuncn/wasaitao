  ...
  <div class="nc-login">
    ...
    <div class="nc-login-content">
      ...
      <?php Security::getToken();?>
        ...
        <dl>
          <dt><?php echo $lang['login_register_sms'];?></dt>
          <dd style="min-height:54px;">
            <input type="text" id="sms" name="sms" class="text w50 fl tip" title="<?php echo $lang['login_register_input_valid_sms'];?>" />
            <a id="get-sms" style="margin-left:10px;" href="javascript:void(0);">立即获取</a>
            <label></label>
          </dd>
        </dl>
        <dl>
          <dt>&nbsp;</dt>
          <dd>
            <input type="button" id="Submit" value="<?php echo $lang['login_register_regist_now'];?>" class="submit" title="<?php echo $lang['login_register_regist_now'];?>" />
