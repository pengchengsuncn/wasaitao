<div class="page">
  <table class="table tb-type2">
    <thead>
      <tr class="space">
        <th colspan="10" class="nobg big"><?php echo $lang['dashboard_aboutus_idea'];?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td class="w12"></td>
        <td><?php echo $lang['dashboard_aboutus_idea_content'];?></td>
      </tr>
    </tbody><tfoot>
      <tr class="tfoot">
        <td colspan="10"></td>
  ...
  <table class="table tb-type2">
    <thead>
      <tr class="space">
        <th colspan="10" class="nobg big"><?php echo $lang['dashboard_aboutus_team'];?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <?php /*?><table class="table tb-type2">
    <thead>
      <tr class="space">
        <th colspan="10" class="nobg big"><?php echo $lang['dashboard_aboutus_near_us'];?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <table class="table tb-type2">
    <thead>
      <tr class="space">
        <th colspan="10" class="nobg big"><?php echo $lang['dashboard_aboutus_thanks'];?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
  ...
  <table class="table tb-type2">
    <thead>
      <tr class="space">
        <th colspan="10" class="nobg big"><?php echo $lang['dashboard_aboutus_notice'];?></th>
      </tr>
    </thead>
    <tbody>
      <tr>
      ...
      <tr class="noborder">
        <td></td>
       <?php echo $lang['dashboard_aboutus_notice4'];?>&nbsp;:&nbsp;&nbsp;jQuery,kindeditor<?php echo $lang['dashboard_aboutus_notice5'];?>.&nbsp;<?php echo $lang['dashboard_aboutus_notice6'];?></td>
      </tr>
    </tbody><?php */?>
    <tfoot>
      <tr class="tfoot">
